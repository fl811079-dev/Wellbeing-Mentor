...
const services = [
  {
    ...
    description: "Evaluación y tratamiento con terapias basadas en evidencia para superar ansiedad, depresión y mejorar tu salud mental.",
    icon: Brain,
    color: "bg-blue-100 dark:bg-blue-900/40 text-blue-600 dark:text-blue-400"
  },
  {
    title: "Mentoría Profesional",
    description: "Acompañamiento estratégico para desarrollar habilidades de liderazgo, transiciones de carrera y toma de decisiones.",
    icon: Compass,
    color: "bg-indigo-100 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400"
  },
  {
    title: "Crecimiento Personal",
    description: "Programas de autodescubrimiento para fortalecer tu resiliencia, autoestima y encontrar el equilibrio en tu vida.",
    icon: Sprout,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">
            Abordamos tu bienestar desde una perspectiva integral, adaptándonos a tus necesidades específicas en cada etapa de tu vida.
          </p>
        </motion.div>
